...
<table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	<tr>
		...
		<td><input style="width:380px;" type="text" name="title" placeholder="请输入新闻标题" maxlength="30" required/></td>
	</tr>
	<tr>
		<td align="right">新闻发布人</td>
		<td><input type="text" name="author"  placeholder="请输入新闻发布人"/><span style="color:#808080;">(默认为52rd)</span></td>
	</tr>
	<tr>
